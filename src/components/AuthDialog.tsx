  ...
  return (
    <div className="fixed inset-0 z-[60]">
      ...
      <div className="relative mx-auto flex h-full max-w-lg items-center px-4">
        <div className="w-full overflow-hidden rounded-3xl border border-[rgba(var(--hairline),var(--hairline-a))] bg-[rgba(var(--paper),0.92)] shadow-[0_24px_80px_rgba(var(--shadow),0.55)]">
